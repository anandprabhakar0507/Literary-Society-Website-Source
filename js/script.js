/*
 This website is developed by Anand Prabhakar,literry society member og GEC
Banka, if,you wish to reuse it(Only in case of educational purpose) you will
need to get the permission contact anandprabhakar0507@gmail.com <meta
name="keywords" content="literary society gec banka,Literary Society GEC
Banka,gec banka,government engineering college banka,banka,litsoc gecbanka,
literarysocietygecbanka,LITERARY SOCIETY GEC BANKA"/> Copyright 2020-Present
Literary Society- G.E.C. Banka.

This website is completely non-commercial and is developed completely for the
educational purpose.
*/
...
var i = 1;
display(i);
function next(x) { display(i += x); }

function now(x) { display(i = x); }
...
function display(x) {
  ...
  if ((counter + 1) > film.length) {
    ...
    alert(
        "You Have viewed all the " + film.length +
